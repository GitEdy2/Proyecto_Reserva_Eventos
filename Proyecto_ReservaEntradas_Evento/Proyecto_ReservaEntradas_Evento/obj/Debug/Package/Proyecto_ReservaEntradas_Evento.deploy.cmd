...
set _DeploySetParametersFile=%RootPath%Proyecto_ReservaEntradas_Evento.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Proyecto_ReservaEntradas_Evento.zip" (
echo "%RootPath%Proyecto_ReservaEntradas_Evento.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%Proyecto_ReservaEntradas_Evento.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%Proyecto_ReservaEntradas_Evento.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%Proyecto_ReservaEntradas_Evento.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%Proyecto_ReservaEntradas_Evento.SetParameters.xml" %_MsDeployAdditionalFlags%
...
:usage
echo =========================================================
if not exist "%RootPath%Proyecto_ReservaEntradas_Evento.deploy-readme.txt" (
...
start notepad "%RootPath%Proyecto_ReservaEntradas_Evento.deploy-readme.txt"
)
echo =========================================================
goto :eof
...
:CheckParameterFile
echo =========================================================
if  exist "%RootPath%Proyecto_ReservaEntradas_Evento.SetParameters.xml" (
echo SetParameters from:
echo "%RootPath%Proyecto_ReservaEntradas_Evento.SetParameters.xml"
echo You can change IIS Application Name, Physical path, connectionString
echo or other deploy parameters in the above file.
) else (
echo SetParamterFiles does not exist in package location.
